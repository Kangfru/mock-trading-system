...
class AccountServiceTest {
    ...
    @Test
    fun `should throw exception when creating account with negative balance`() =
        runTest {
            val user = userService.createUser("testuser", "test@example.com")
    ...
    @Test
    fun `should throw exception when creating account for non-existent user`() =
        runTest {
    ...
    @Test
    fun `should get accounts by user id`() =
        runTest {
            val user = userService.createUser("testuser", "test@example.com")
    ...
    @Test
    fun `should throw exception when buying stock with invalid quantity`() =
        runTest {
            val user = userService.createUser("testuser", "test@example.com")
            val account = accountService.createAccount(user.seq, BigDecimal("10000.00"))
    ...
    @Test
    fun `should throw exception when buying stock with invalid price`() =
        runTest {
            val user = userService.createUser("testuser", "test@example.com")
            val account = accountService.createAccount(user.seq, BigDecimal("10000.00"))
    ...
    @Test
    fun `should throw exception when selling stock with invalid quantity`() =
        runTest {
            val user = userService.createUser("testuser", "test@example.com")
            val account = accountService.createAccount(user.seq, BigDecimal("10000.00"))
            accountService.buyStock(account.accountNumber, "AAPL", 10, BigDecimal("150.00"))
    ...
    inner class ConcurrencyTests {
        @Test
        fun `should handle concurrent deposits correctly`() =
            runTest {
                // Given
                val user = userService.createUser("testuser", "test@example.com")
                val account = accountService.createAccount(user.seq, BigDecimal("1000.00"))
        ...
        @Test
        fun `should handle concurrent withdrawals correctly`() =
            runTest {
                // Given
                val user = userService.createUser("testuser", "test@example.com")
        ...
        @Test
        fun `should handle concurrent deposits and withdrawals correctly`() =
            runTest {
                // Given
                val user = userService.createUser("testuser", "test@example.com")
                val account = accountService.createAccount(user.seq, BigDecimal("1000.00"))
        ...
        @Test
        fun `should handle concurrent stock purchases correctly`() =
            runTest {
                // Given
                val user = userService.createUser("testuser", "test@example.com")
                val account = accountService.createAccount(user.seq, BigDecimal("10000.00"))
        ...
        @Test
        fun `should handle concurrent stock sales correctly`() =
            runTest {
                // Given
                val user = userService.createUser("testuser", "test@example.com")
                val account = accountService.createAccount(user.seq, BigDecimal("10000.00"))
        ...
        @Test
        fun `should handle concurrent operations on different accounts independently`() =
            runTest {
                // Given
                val user = userService.createUser("testuser", "test@example.com")
                ...
                val account1Operations =
                    List(operationsPerAccount) {
                        async {
                            accountService.deposit(account1.accountNumber, amount)
                        }
                    }
                val account2Operations =
                    List(operationsPerAccount) {
                        async {
