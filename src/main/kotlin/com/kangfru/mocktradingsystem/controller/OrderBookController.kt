...
class OrderBookController(
    ...
    ): OrderBookSnapshot = orderBookService.getOrderBookSnapshot(stockCode)

    /**
     * 모든 종목 호가창 조회
     */
    @GetMapping
    fun getAllOrderBooks(): Map<String, OrderBookSnapshot> = orderBookService.getAllOrderBookSnapshots()
}
