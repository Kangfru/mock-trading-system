...
data class Account(
    ...
    fun buyStock(stockCode: String, quantity: Int, price: BigDecimal): Account {
        ...
        val newHolding = if (currentHolding == null) {
    ...
    fun sellStock(stockCode: String, quantity: Int, price: BigDecimal): Account {
        val currentHolding = holdings[stockCode]
        ...
        val newHoldings = if (newHolding == null) {
            holdings - stockCode
        } else {
    ...
    fun hasStock(stockCode: String, quantity: Int): Boolean {
